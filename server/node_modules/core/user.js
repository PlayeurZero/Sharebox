...
class User {
	...
	static validateCredentials(var1) {
		...
		let filepath = require('path').normalize(require('process').cwd() + '/server/users/' + username + '.json');
		...
		fs.readFile(filepath, (err, data) => {
			...
			if(!(parsed_data.password === require('crypto').createHash("sha256").update(password).update(username).digest("base64"))) {
