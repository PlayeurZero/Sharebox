...
class HTTPServer {
	...
	run() {
		...
		server.on('request', (req, res) => {
			...
			else if(pathname == 'signin') this.redirect(req, res, '/index.html');
			else if(pathname == 'signup') this.redirect(req, res, '/index.html');
			else if(pathname == 'chat') this.redirect(req, res, '/index.html');
	...
	download(req, res, filename, name) {
		let file = path.normalize('server/uploads/' + filename);
